...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
  ...
  hi Visual           ctermbg=111  ctermfg=235  guibg=#d7ffff guifg=#262626 cterm=NONE           gui=NONE
  ...
  hi signColumn       ctermbg=251  ctermfg=235  guibg=NONE    guifg=NONE    cterm=NONE           gui=NONE
